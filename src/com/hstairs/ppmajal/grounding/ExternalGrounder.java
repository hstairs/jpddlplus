...
public abstract class ExternalGrounder {
  ...
  protected Collection<TransitionGround> extractActions(
      HashMap<String, Collection<List<String>>> groundings) {
      ...
      if (t instanceof TransitionSchema) {
        ...
        if (get == null) {
          ...
          for (List<String> ele : get) {
            ...
            final TransitionGround ground = Grounder.ground(schema, p, problem.getObjects(),
                problem);
            actions.add(ground);
          }
        }

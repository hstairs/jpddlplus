...
public class PDDLObjects extends LinkedHashSet<PDDLObject> {
   ...
   * @return true if the specified PDDL object appears in this list of PDDL objects.
   */
   ...
   * @return the type of the specified PDDL object if valid, <code>null</code> otherwise.
   */
  ...
  /**
   * Returns the PDDL object equivalent to the specified one. When constructing a PDDLObject, it is
   * always preferable to replace it immediately with the result of the call to this method, as it
   * reduces the memory consumption.
   *
   * @param t the PDDL object.
   * @return the PDDL object equivalent to the specified one that appears in this list of PDDL
   * objects if existing, <code>null</code> otherwise.
   */

...
public class RelState {
  ...
  public String toString() {
    ...
    for (int i : possNumValues.keySet()) {
      ...
      str.append(fluent).append("=").append(possNumValues.get(i));
    }
    str.append("\n");
  ...
  public boolean equals(Object obj) {
    return obj.toString()
        .equals(this.toString()); //To change body of generated methods, choose Tools | Templates.
  }
...
//    }
  ...
  public void apply(Collection<Terminal> effect, RelState prev) {
    effect.forEach(o -> this.apply((PostCondition) o, prev));
  }
  ...
  public void apply(TransitionGround gr, RelState prev) {
    ...
    for (final ConditionalEffects<PostCondition> eff : effs) {
      for (final Map.Entry<Condition, Collection<PostCondition>> entry : eff.getActualConditionalEffects()
          .entrySet()) {

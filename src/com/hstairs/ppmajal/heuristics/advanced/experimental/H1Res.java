...
//                        return first - second;
            return (int) (estimateCost((Condition) t1, previous) - estimateCost((Condition) t,
                previous));
...
//            System.out.println("Tot Cost: "+max);
  ...
  protected float computeEstimateForStore(State gs) {
    ...
    return super.computeEstimateForStore(

...
import com.hstairs.ppmajal.pddl.heuristics.novelty.objects.NumericAtomAssignment;
...
public class AtomWidthHeuristic extends NoveltyHeuristic {
  ...
  public AtomWidthHeuristic(PDDLProblem problem, int k, SearchHeuristic[] heuristics) {
    super(problem, k, NoveltyValue.WIDTH, NoveltyType.ATOM);

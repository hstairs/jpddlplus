...
public class LmCut extends H1 {
    ...
    private record JGraph(Collection<Integer> V, IntArrayList[][] E, Collection<Integer>[] ERev) {
    }
    ...
    private LmCut(PDDLProblem problem, boolean additive, boolean extractRelaxedPlan, boolean maxHelpfulTransitions,
                  String redConstraints, boolean helpfulActionsComputation, boolean reachability,
    ...
    Float updateJG(JGraph jg, State gs, Collection<Cut> cuts) {
        ...
        while (!heap.isEmpty()) {
            ...
            jg.E[pcf[actionId]][actionId] = null;
        ...
        if (c instanceof AndCond and) {
            ...
            for (final var son : and.sons) {
                ...
                if (child.getFirst() == Float.MAX_VALUE) {
                    return Pair.of(Float.MAX_VALUE, null);
                }

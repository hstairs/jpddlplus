...
public abstract class Expression {
  ...
  /**
   * Substitutes the variables in this expression with the PDDLObjects associated to each variable
   * in the specified table.The returned expression is therefore grounded. This method may fail if
   ...
   * @param po
   * @return a copy of this expression where each variable is replaced to the object according to

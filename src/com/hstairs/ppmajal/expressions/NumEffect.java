...
public class NumEffect extends Expression implements PostCondition {
  ...
  public Expression weakEval(PDDLProblem problem, Set invF) {
    ...
    if (this.right == null) {
      ...
      return null;
    } else if (this.right instanceof PDDLNumber rhs_number) {
    ...
    for (Object o : numeric.sons) {
      ...
      if (ef.fluentAffected.equals(ret.fluentAffected)) {
        ...
        if (ef.getOperator().equals("assign")) {
          ret.setRight(
              new BinaryOp(ret.right, "-", new BinaryOp(ef.right, "-", ret.fluentAffected, true),
                  true));
  ...
  public String toSmtVariableString(int i) {
    ...
    if (this.operator.equals("increase")) {
      ...
      return "(= " + this.getFluentAffected().toSmtVariableString(i + 1) + " "
          + op.toSmtVariableString(i) + ")";
      ...
      return "(= " + this.getFluentAffected().toSmtVariableString(i + 1) + " " + this.getRight()
          .toSmtVariableString(i) + ")";
    }
  ...
  public String to_smtlib_with_repetition(int i, String var) {
    ...
    return "(= " + this.getFluentAffected().toSmtVariableString(i + 1) + " "
        + this.to_smtlib_with_repetition_for_the_right_part(i, var) + ")";
  }
  ...
  public String to_smtlib_with_repetition_for_the_right_part(int i, String var) {
    ...
    //rhs(e) \cap lhs(e) = \emptyset
    if (this.operator.equals("increase")) {
      return "(+ " + this.getFluentAffected().toSmtVariableString(i) + " (* " + var + " "
      ...
      if (alpha == null) {
        ...
        return "(- " + this.getFluentAffected().toSmtVariableString(i) + " (* " + var + " "
            + new_right.toSmtVariableString(i) + " ))";
      } else if (alpha == 1f) {
        return "(+ " + this.getFluentAffected().toSmtVariableString(i) + " (* " + var + " "
            + new_right.toSmtVariableString(i) + " ))";
      } else {
        String exp_variable = "(/ (^ " + alpha + " (+ " + var + " 1) )(- " + alpha + " 1) )";
        return "(+ (* (^ " + alpha + " " + var + " ) " + this.getFluentAffected()
            .toSmtVariableString(i) + " )" + " "
...
//        }
  ...
  public void apply(RelState s, Map modifications) {
    ...
    if (this.getOperator().equals("increase")) {
      ...
      } else if (current == null || ((Double.isNaN(current.lo())) && (Double.isNaN(
          current.hi())))) {
        after = new HomeMadeRealInterval(eval.lo(), eval.hi());
      } else {
        after = new HomeMadeRealInterval(

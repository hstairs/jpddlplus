...
public class DPEX extends SearchEngine {
    ...
    public  DPEX(float hw, boolean optimality, boolean helpfulActionsPruning,
            ...
            if (currentNode.gValue == getPreviousCost(gValue, currentNode.s)){
                ...
                do { 
                    ...
                    if (inputBounds != null && currentNode.s instanceof com.hstairs.ppmajal.PDDLProblem.PDDLState) {
                        com.hstairs.ppmajal.PDDLProblem.PDDLState pddlState = (com.hstairs.ppmajal.PDDLProblem.PDDLState) currentNode.s;
                    ...
                    Iterator<Pair<State, Object>> it = problem.getSuccessors(currentNode.s, actionsToSearch);
                    while (it.hasNext()) {
                ...
                for (Pair<State, Object> next : sampled) {
                    ...
                    if (successorG < gBound) {
                        ...
                        switch (this.queueSuccessor(frontier, successorState, currentNode, act,
                                getPreviousCost(gValue, successorState), successorG, gValue, h, hw, sampledInputs)) {

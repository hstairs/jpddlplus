...
- `-floor <true|false>`: enable the numeric activation floor for H1/HMax, CPZeroCut, and LM-Cut (default: `true`)
- `-h cpzerocut`: use complete zero-set support zeroing; selective zeroing modes are not exposed

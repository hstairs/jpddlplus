(define (problem mprime-x-2)
   ...
   (:objects beef onion tuna flounder cherry muffin ham - food
             ...
             jealousy jealousy_2 depression_1 grief_7 dread_8
             prostatitis_3 boils_4 - pain
)
   (:init 
...
(= (locale muffin) 2)
          ...
          (craves grief_7 ham)
(= (harmony curiosity) 2)
          (craves jealousy_2 cherry)
          (craves angina onion)
          (craves depression_1 muffin)
          (eats muffin tuna)
          (craves anger beef)
(= (locale cherry) 4)
          (eats beef onion)
          ...
          (craves boils tuna)
          (eats tuna beef)
          (craves prostatitis_3 ham)
          (eats ham muffin)
          (craves dread_8 ham)
          (craves depression beef)
)
   (:goal (and (craves grief_7 beef)
               (craves depression_1 beef))))
